...
m.8.Final.c <- lm(OVERALL_COURSE_GRADE ~ LOG_MEAN_PI,  data = studentSummary_21A)
summary(m.8.Final.c)
...
scatter_plot(title = "LOG_MEAN_PI vs FINAL_EXAM_SCORE", df = studentSummary_21A, xvar = "LOG_MEAN_PI", 
             yvar = "FINAL_EXAM_SCORE", xlim = c(-5,1), ylim = c(0,100), a = coef(m.6.Final)[1], b = coef(m.6.Final)[2])
...
scatter_plot(title = "LOG_MEAN_PI vs COURSE_GRADE", df = studentSummary_21A, xvar = "LOG_MEAN_PI", 
             yvar = "OVERALL_COURSE_GRADE", xlim = c(-5,1), ylim = c(0,100), a = coef(m.8.Final)[1], b = coef(m.8.Final)[2])
