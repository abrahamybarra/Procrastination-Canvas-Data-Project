...
## Plot HOUR_DIFF by assignment type

```{r}
######## Plot HOUR_DIFF by assignment type: DENSITY ############
wBin = 5

ggplot(assignments_21A) +
    
  # aesthetics
  geom_histogram(aes(x = HOUR_DIFF, y = wBin*..density..), binwidth = wBin, color = "blue", fill = "blue", alpha = .5) +
  facet_wrap(~ ASSIGNMENT_TYPE) +
  
  xlim(-100,100) +
      
  # title and label axes
  ggtitle(paste("Distribution of HOUR_DIFF")) +
  xlab("HOUR_DIFF") +
  ylab("Density")
...
ggsave(paste0(here(),"/Plots/Descriptive Stats/HOUR_DIFF by ASSIGNMENT_TYPE.jpeg"))
```
