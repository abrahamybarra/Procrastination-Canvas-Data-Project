...
get_section=function(path){
  section = read.csv(path) %>%
    ...
    mutate(Section.Id = gsub('PSYC 2145', 'F21', Section.Id))
  return(section)
}

f1_section = get_section(paste0(here(),"/raw_data/F21/gradebook.csv"))
#f2_section = get_section(paste0(here(),"/raw_data/F22/gradebook.csv"))
