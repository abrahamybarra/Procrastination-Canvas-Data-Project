...
# Print the names of all assignments with missing_21 due dates
missing_21_due_21 <- assignments_21 %>%
  filter(DUE_DATE == "")
list_missing_21_due = unique(missing_21_due_21$ASSIGNMENT_NAME)
num_missing_21_due = length(list_missing_21_due)
...
list_missing_21_submit = unique(submit_noTime_21$ASSIGNMENT_NAME)
num_missing_21_submit = length(list_missing_21_submit)
```
